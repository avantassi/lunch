...
$(document).ready(function() {
    ...
    $('.dostavka').on('click', function(e){
        ...
        if( doc_w > 1024){
            ...
            $('html,body').stop().animate({scrollTop: ($('#it_dostavka').offset().top - 290)}, 1000);
        } else {

            $('html,body').stop().animate({scrollTop: ($('#it_dostavka').offset().top - 30)}, 1000);
        }
    ...
    $('.menu').on('click', function(e){
        $('html,body').stop().animate({ scrollTop: $('#it_menu').offset().top }, 1000);
        e.preventDefault();
    });
